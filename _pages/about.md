...
I also work part-time for SideFX Software as a software developer, developing tools for their fluid simulation pipeline. I have designed several new features such as their surface tension and suction fluid tools, narrow-band FLIP, and new ocean simulation tools (guided volumes and boundary layer). My [Masterclass](https://vimeo.com/209763376) video highlighting the new features I designed for Houdini 16 has over 40 thousand views.
